...
final class Version20250528232055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE avis (id SERIAL NOT NULL, user_id INTEGER NOT NULL, covoiturage_id INTEGER DEFAULT NULL, commentaire VARCHAR(255) NOT NULL, note VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, valide BOOLEAN DEFAULT 0 NOT NULL, CONSTRAINT FK_8F91ABF0A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_8F91ABF062671590 FOREIGN KEY (covoiturage_id) REFERENCES covoiturage (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
